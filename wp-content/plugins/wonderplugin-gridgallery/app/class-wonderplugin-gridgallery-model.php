...
class WonderPlugin_Gridgallery_Model {
	...
	function generate_a_code($slide, $data, $id, $hide_item, $socialmedia) {
	...
	function generate_image_code($slide, $data, $id, $hide_item, $socialmedia) {
		...
		if (!isset($data->applylinktotext) || (strtolower($data->applylinktotext) !== 'true'))
			$code_template .= $this->generate_a_code($slide, $data, $id, $hide_item, $socialmedia);
	...
	function generate_body_code($id, $has_wrapper, $datatags = null) {
		...
		{	
			...
			$boolOptions = array('mediumgridsize', 'smallgridsize', 'applylinktotext', 'fullwidth', 'supportshortcode', 'donotzoomin', 'enabletabindex', 'masonrymode', 'random', 'shownavigation', 'shownavcontrol', 'hidenavdefault', 'nohoverontouchscreen', 'hoverzoomin', 'hoverzoominimageonly', 'hoverzoominimagecenter', 'hoverfade', 'responsive', 'mediumscreen', 'smallscreen', 'showtitle', 'showtexttitle', 'showtextdescription', 'showtextbutton', 'overlaylink','donotaddtext', 'lightboxnogroup', 'lightboxcategorygroup', 
					...
					'lightboxfullscreentextoutside', 'lightboxfullscreenmodeonsmallscreen', 'lightboxfullscreentextinside', 'triggerresizeafterinit', 'removeinlinecss',
			...
			$valOptions = array('smallimgheightpercent', 'mediumimgheightpercent', 'imgheightpercent', 'smallimgwidthpercent', 'mediumimgwidthpercent', 'imgwidthpercent', 'mediumwidth', 'mediumheight', 'smallwidth', 'smallheight', 'thumbwidth', 'thumbheight', 'thumbtopmargin', 'thumbbottommargin', 'barheight', 'titlebottomcss', 'descriptionbottomcss', 'googleanalyticsaccount', 'gap', 'margin', 'borderradius', 
					'justifymaxheight',
