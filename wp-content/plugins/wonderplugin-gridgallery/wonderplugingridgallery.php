<?php
/*
Plugin Name: Wonder Grid Gallery Pro
...
define('WONDERPLUGIN_GRIDGALLERY_VERSION', '16.4C');
...
define('WONDERPLUGIN_GRIDGALLERY_PLUGIN_VERSION', '16.4');
...
class WonderPlugin_Gridgallery_Plugin {
	...
	function register_menu()
	{
		...
		$menu = add_menu_page(
				__('Wonder Grid Gallery Pro', 'wonderplugin_gridgallery'),
				__('Wonder Grid Gallery Pro', 'wonderplugin_gridgallery'),
				$userrole,
